...
# ── Logo als Base64 laden (logo.png im selben Ordner) ─────────────────────────
def logo_laden():
    logo_pfad = "logo.png"
    if os.path.exists(logo_pfad):
        ...
        # Fallback: Textlogo wie bisher
        return '''<div style="text-align:right; font-family:\'IM Fell English\',\'Palatino Linotype\',serif;
                  font-size:13px; font-weight:bold; color:red; line-height:1.2;">
...
/* ── Startseiten-Titel (gleiche Schrift wie Such-/Hochladeseite) ── */
.start-titel {
...
/* ── Große Buttons (Suchen / Hochladen) – GLEICHE Größe auf allen Seiten ── */
...
# ══════════════════════════════════════════════════════════════════════════════
def startseite():
    # Logo oben rechts (Katharineum)
    st.markdown(LOGO_HTML, unsafe_allow_html=True)
    st.markdown("<div style='height:16px'></div>", unsafe_allow_html=True)

    # Titel in gleicher Schrift wie Such-/Hochladeseite
